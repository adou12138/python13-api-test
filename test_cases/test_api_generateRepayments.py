...
class GenerateRepaymentsTest(unittest.TestCase):
    ...
    cases_generateRepayments = do_excel.read_excel("generateRepayments")  # 读取register_sheet
    ...
    def test_generateRepayments(self, case):  # 测试注册
        ...
        # generateRepayments_data_new = Context.replace(case.data, generateRepayments_information)
